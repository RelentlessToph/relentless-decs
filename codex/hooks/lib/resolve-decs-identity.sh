#!/bin/bash
# decs-version: 1.1.0 (relentless-decs-codex plugin — vendored copy of decs/lib/resolve-decs-identity.sh, identical minus this line; pinned by decs/tests/plugin-resolver-vendored-test.sh)
#
