#!/bin/bash
# decs-version: 1.2.0 (relentless-decs plugin — vendored copy of decs/lib/resolve-decs-identity.sh, identical minus this line; pinned by decs/tests/plugin-resolver-vendored-test.sh)
#
